...
### Это подзадание поможет тебе, Артем, познакомиться с основными структурами управления на языке С, а также с итеративными и рекурсивными алгоритмами
...
> Начиная с этого дня все программы, помимо тестов на корректный вывод, будут также тестироваться на стилевые нормы. Перед  тем как захочешь сдать задание на проверку, можно протестировать
